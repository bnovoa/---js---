define(function(require, exports, module) {
	...
	*/
	...
	Magic.prototype.weiboLogin = function(success) {
		// console.log()
		$.post(magicConstant.weiboAuthor.url,{"client_id":magicConstant.weiboAuthor.clientId,"redirect_uri":magicConstant.weiboAuthor.redirectUri,"scope":magicConstant.weiboAuthor.scope,"state":magicConstant.weiboAuthor.state}, success, "json");
	}
	//补全信息
