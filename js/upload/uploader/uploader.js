//GJ.add('js/app/mobile/uploader/uploader.js', [], function(){});
GJM=GJM||{};
GJM.image=GJM.image||{};
//config
GJM.image.config ={
        url: 'http://image.ganji.com/upload.php',
        urlEdit: 'http://image.ganji.com/upload_op.php',
        //$el: '#uploader',
        maxNum: 3,
        type: ['jpg']
};
...
//    
//    Uploader.prototype.delete  =function(id) {
...
GJM.image.Uploader=GJM.image.Uploader||uploadFn;