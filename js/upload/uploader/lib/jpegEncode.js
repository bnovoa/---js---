//GJ.add('js/app/mobile/uploader/lib/jpegEncode.js', [], function(){});
GJM=GJM||{};
GJM.lib=GJM.lib||{};
GJM.lib.JPEGEncoder = (function() {
            ...
            while (y < height) {
                ...
                while (x < quadWidth) {
                    ...
                    for (pos = 0; pos < 64; pos++) {
                        ...
                        g = imageData[p++];
                        b = imageData[p++];
                        YDU[pos] = (RGB_YUV_TABLE[r] + RGB_YUV_TABLE[g + 256 >>
                        0] + RGB_YUV_TABLE[b + 512 >> 0] >> 16) - 128;
